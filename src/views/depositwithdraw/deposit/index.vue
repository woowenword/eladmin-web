  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-select v-model="query.currency_id" clearable size="small" placeholder="币种" class="filter-item" style="width: 90px" @change="crud.toQuery">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column label="充值时间" prop="name" />
      <el-table-column label="状态" align="center" prop="deptSort">
      ...
      <el-table-column label="是否跨链" prop="name" />
      <el-table-column label="原始链" prop="name" />
      <el-table-column label="原币种" prop="name" />
      <el-table-column label="充值帐户" prop="name" />
      <el-table-column label="交易TXID" prop="name" />
      <el-table-column label="确认到账时间" prop="name" />
...
export default {
  ...
  cruds() {
    return CRUD({ title: '充值管理', url: 'api/dewi/deposits', crudMethod: { ...crudDept }})
  },
